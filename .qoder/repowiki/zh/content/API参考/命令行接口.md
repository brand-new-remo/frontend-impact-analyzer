...
## 更新摘要
**变更内容**
- 新增 `--force-config` 参数用于强制覆盖现有配置文件
- 改进 doctor 命令输出，增加虚拟环境隔离检测和建议的命令前缀
- 增强配置文件管理的安全性和用户体验
...
**章节来源**
- [front_end_impact_analyzer.py:1-406](file://scripts/front_end_impact_analyzer.py#L1-L406)
- [workflow.py:1-390](file://scripts/analyzer/workflow.py#L1-L390)
...
**图表来源**
- [front_end_impact_analyzer.py:239-406](file://scripts/front_end_impact_analyzer.py#L239-L406)
- [models.py:115-161](file://scripts/analyzer/models.py#L115-L161)
...
**图表来源**
- [front_end_impact_analyzer.py:362-401](file://scripts/front_end_impact_analyzer.py#L362-L401)
